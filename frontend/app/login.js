...
const FocusableInput = ({ placeholder, secureTextEntry, icon, isPassword, value, onChangeText }) => {
    ...
    return (
        <View style={[
            ...
            {icon && <Text style={[styles.inputIcon, isFocused && {color: '#8B5CF6', opacity: 1}]}>{icon}</Text>}
            <TextInput 
         ...
         <Animated.View style={[{ flex: 1, width: '100%', opacity: fadeAnim }]}>
           <ScrollView contentContainerStyle={styles.scrollContent}>
               <Animated.View style={[styles.authCard, { transform: [{ translateY: floatAnim }] }]}>
                   ...
                   <Text style={styles.headerSubtitle}>Sign in to continue your AI journey</Text>
                   ...
                   <View style={styles.formContainer}>
                       ...
                       <FocusableInput placeholder="••••••••" secureTextEntry={true} isPassword={true} icon="🔒" value={password} onChangeText={setPassword} />

                       <HoverableButton 
                          style={[styles.primaryButton, Platform.OS === 'web' && { backgroundImage: 'linear-gradient(90deg, #6366F1, #8B5CF6)' }]} 
...
const styles = StyleSheet.create({
  ...
  authCard: {
      ...
      borderRadius: 24, padding: 40, overflow: 'hidden',
  ...
  inputFieldFocused: { 
      ...
      ...(Platform.OS === 'web' && { boxShadow: '0 0 8px rgba(138, 43, 226, 0.5)' }) 
  },
  ...
  primaryButton: { backgroundColor: '#6366F1', paddingVertical: 16, borderRadius: 12, alignItems: 'center', marginTop: 10, shadowColor: '#6366F1', shadowOpacity: 0.3, shadowRadius: 10, shadowOffset: { width: 0, height: 4 } },
  primaryButtonHover: { transform: [{ translateY: -2 }], shadowOpacity: 0.5, ...(Platform.OS === 'web' && { boxShadow: '0 10px 25px rgba(99,102,241,0.5)' }) },
